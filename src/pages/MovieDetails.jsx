...
import "../components/MoviesGrid/MoviesGrid"
...
export function MovieDetails() {
  ...
  useEffect(() => {
    ...
    get("/movie/" + movieid + "/similar?language=es-ES").then((data) => {
  ...
  let presupuesto = new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'USD' }).format(movieSingular.budget)
  ...
  return (
    <div>
      <div className={style.detailsContainer}>
        ...
        <div className={style.col + " " + style.datos}><b>Presupuesto</b><br/>{presupuesto}</div>
      </div>
